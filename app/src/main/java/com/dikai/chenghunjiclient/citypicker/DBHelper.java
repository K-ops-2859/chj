...
/**
 * Created by Lucio on 2016/9/11.
 */
public class DBHelper extends SQLiteOpenHelper {
    // 用户数据库文件的版本
    private static final int DB_VERSION = 1;
    // 数据库文件目标存放路径为系统默认位置，com.lihengtong.freetrip 是你的包名
     ...
     */
    private static String DB_PATH = "/data/data/com.dikai.chenghunjiclient/databases/";
    private static String DB_NAME = "city.sqlite";
    private static String ASSETS_NAME = "Coupon.sqlite";
