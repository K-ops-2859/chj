...
public class MyWedApplyActivity extends AppCompatActivity implements View.OnClickListener, OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_wed_apply);
    ...
    private void init() {
        ...
        mCheckBoxText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MyWedApplyActivity.this, WedRuleActivity.class)
...
//                    Toast.makeText(this, "请输入酒店地点！", Toast.LENGTH_SHORT).show();
                    ...
                    String inviteMan = checkInput(invitePhone)? invitePhone.getText().toString():"";
                    ...
                    if(isGroom){
                        apply(inviteMan,name.getText().toString(),phone.getText().toString(),"","",
    ...
    private void apply(String inviteMan, String groomname,String groomphone,String bridename,String bridephone,
        ...
        NetWorkUtil.setCallback("HQOAApi/AddNewInformation",
                new BeanApplyWed(info.getUserId(),"0","2",inviteMan,groomname,groomphone,bridename,bridephone,
                    ...
                    public void onFinish(final String respose) {
                        ...
                        try {
                            ...
                            if ("200".equals(result.getMessage().getCode())) {
                                Toast.makeText(MyWedApplyActivity.this, "您的申请已成功提交，请静候佳音！", Toast.LENGTH_LONG).show();
                                finish();
                            } else {
