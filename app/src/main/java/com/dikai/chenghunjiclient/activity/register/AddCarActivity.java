...
public class AddCarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        logo = (ImageView) findViewById(R.id.activity_add_car_logo);
        brandText = (TextView) findViewById(R.id.activity_add_car_brand);
        typeEdit = (EditText) findViewById(R.id.activity_add_car_type);
        colorEdit = (EditText) findViewById(R.id.activity_add_car_color);
        findViewById(R.id.activity_add_car_back).setOnClickListener(this);
        findViewById(R.id.activity_add_car_finish).setOnClickListener(this);
        logo.setOnClickListener(this);
        initImagePicker();
        if(brand != null){
            brandText.setText(brand.getName());
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.activity_add_car_back:
                onBackPressed();
                break;
            case R.id.activity_add_car_finish:
                onBackPressed();
                break;
            case R.id.activity_add_car_logo:
                openPhoto();
                break;
