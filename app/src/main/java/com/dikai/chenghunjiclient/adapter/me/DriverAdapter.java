...
/**
 * Created by Lucio on 2017/9/4.
 */

public class DriverAdapter extends RecyclerView.Adapter<DriverAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_select_driver_layout, parent, false);
...
//        }
    ...
    public void addAll(Collection<? extends MemberBean> collection){
        int size = list.size();
        list.addAll(collection);
        notifyItemRangeInserted(size, collection.size());
    }

    public void refresh(Collection<? extends MemberBean> collection){
        list = new ArrayList<>();
        list.addAll(collection);
    ...
    public void onClick(View v) {
        ...
        if(v == holder.mLayout){
            ...
            mMoreClickListener.onClick(holder.more, position, list.get(position));
        }
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            more = ((ImageView) itemView.findViewById(R.id.item_driver_more));
    ...
    public interface OnMoreClickListener{
        void onClick(View view, int position, MemberBean bean);
    }
}