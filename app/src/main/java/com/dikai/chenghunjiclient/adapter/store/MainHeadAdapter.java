...
/**
 * Created by Lucio on 2017/8/24.
 */

public class MainHeadAdapter extends RecyclerView.Adapter<MainHeadAdapter.MyViewHolder> implements View.OnClickListener {

    private Context context;
    private List<NewIdentityBean> list;

    public MainHeadAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_main_head_layout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(context).load(bean.getIcon()).into(holder.img);
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            img = ((ImageView) itemView.findViewById(R.id.item_head_img));
            mLayout = (LinearLayout) itemView.findViewById(R.id.item_head_layout);
        }
    }
