...
public class DynamicAdapter extends RecyclerView.Adapter<DynamicAdapter.DiscoverVH> implements View.OnClickListener {
    ...
    @Override
    public DiscoverVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.new_dynamic_item_layout, parent, false);
        DiscoverVH holder = new DiscoverVH(view, onItemClickListener, mData);
    ...
    @Override
    public void onBindViewHolder(final DiscoverVH holder, final int position) {
...
//        Glide.with(mContext).load(dataList.getDynamicerHeadportrait()).into(holder.civLogo);
    ...
    public void onClick(View view) {
        DiscoverVH holder = (DiscoverVH) view.getTag();
...
//    }
    ...
    static class DiscoverVH extends RecyclerView.ViewHolder {
        ...
        public DiscoverVH(View itemView, final OnItemClickListener<DynamicData.DataList> listener, final List<DynamicData.DataList> data) {
            super(itemView);
