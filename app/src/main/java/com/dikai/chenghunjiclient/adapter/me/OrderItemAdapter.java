...
public class OrderItemAdapter extends RecyclerView.Adapter<OrderItemAdapter.MyViewHolder> implements View.OnClickListener {

    private Context context;
    private List<NewOrderItemBean> list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        NewOrderItemBean bean = list.get(position);
        holder.name.setText(bean.getCommodityName());
        holder.type.setText(bean.getSpecificationModelIdName());
        holder.price.setText("￥"+bean.getQuate());
    ...
    public void addAll(Collection<? extends NewOrderItemBean> collection){
        int size = list.size();
        list.addAll(collection);
        notifyItemRangeInserted(size, collection.size());
    }

    public void refresh(Collection<? extends NewOrderItemBean> collection){
        list = new ArrayList<>();
        list.addAll(collection);
    ...
    public interface OnItemClickListener{
        void onClick(NewOrderItemBean bean);
    }
}