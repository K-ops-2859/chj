...
public class InviteDownLoadAdapter extends RecyclerView.Adapter<InviteDownLoadAdapter.InviteDownLoadVH> {
    ...
    @Override
    public InviteDownLoadVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_invite_download, parent, false);
        return new InviteDownLoadAdapter.InviteDownLoadVH(view, onItemClickListener, mData);
    }

    @Override
    public void onBindViewHolder(InviteDownLoadVH holder, final int position) {
...
//                        onAdapterViewClickListener.onAdapterClick(view, position);
//                    }
//                });
//            } else {
...
//                    ((GridLayoutManager) layoutManager).getSpanSizeLookup();
    ...
    static class InviteDownLoadVH extends RecyclerView.ViewHolder {
        ...
        public InviteDownLoadVH(View itemView, final OnItemClickListener listener, final List<WrapperPrizeData> data) {
            super(itemView);
            ...
            if (listener != null) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        int position = InviteDownLoadAdapter.InviteDownLoadVH.this.getAdapterPosition();
