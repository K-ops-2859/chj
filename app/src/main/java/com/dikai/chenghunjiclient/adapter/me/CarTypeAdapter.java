...
/**
 * Created by Lucio on 2017/9/7.
 */

public class CarTypeAdapter extends RecyclerView.Adapter<CarTypeAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.name.setText(bean.getName() + " - " + bean.getColor());
    }
    ...
    public void addAll(Collection<? extends CarBean> collection){
        int size = list.size();
        list.addAll(collection);
        notifyItemRangeInserted(size, collection.size());
    }

    public void refresh(Collection<? extends CarBean> collection){
        list = new ArrayList<>();
        list.addAll(collection);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            mLayout = (LinearLayout) itemView.findViewById(R.id.item_my_friend_layout);
        }
    }
