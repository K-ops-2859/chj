...
public class DriverPlanFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_driver_plan, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mCalendarFragment = new DriverCalenderFragment();
        mDriverNewAddFragment = new DriverNewAddFragment();
        Collections.addAll(mFragments, mCalendarFragment, mDriverNewAddFragment);
    ...
    public void onClick(View v) {
        if(v == addPlan){
            startActivity(new Intent(getContext(), AddPlanActivity.class).putExtra("type",2));
        }
    }
}
