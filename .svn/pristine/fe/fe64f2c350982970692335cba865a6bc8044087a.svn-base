...
public class FailFragment extends Fragment {
    ...
    public static FailFragment newInstance(String clientId) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fali, container, false);
    }
    ...
    private void initData() {
        ...
        NetWorkUtil.setCallback("User/GetFileSupplier", new BeanPhotoDetails("0", clientId + "", "3", "1", "", "", pagerIndex + "", pagerCount + ""), new NetWorkUtil.CallBackListener() {
            @Override
            public void onFinish(String respose) {
                ...
                if (photoDetailsData.getMessage().getCode().equals("200")) {
                    if (photoDetailsData.getData().size() == 0) {
                        ...
                        images.clear();
                        for (PhotoDetailsData.DataList dataList1 : photoLists) {
