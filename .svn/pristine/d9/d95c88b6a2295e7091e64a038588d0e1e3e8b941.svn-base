...
/**
 * Created by Lucio on 2018/1/17.
 */

public class HomeSupListAdapter extends RecyclerView.Adapter<HomeSupListAdapter.StorePicsViewHolder> implements View.OnClickListener {
    ...
    @Override
    public HomeSupListAdapter.StorePicsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_home_sup_layout, parent, false);
        HomeSupListAdapter.StorePicsViewHolder holder = new HomeSupListAdapter.StorePicsViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(HomeSupListAdapter.StorePicsViewHolder holder, int position) {
    ...
    public void onClick(View v) {
        if(UserManager.getInstance(context).isLogin()){
            HomeSupListAdapter.StorePicsViewHolder holder = (HomeSupListAdapter.StorePicsViewHolder) v.getTag();
            NewSupsBean bean = list.get(holder.getAdapterPosition());
