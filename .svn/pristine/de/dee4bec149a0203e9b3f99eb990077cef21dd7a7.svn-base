...
import com.dikai.chenghunjiclient.entity.FlowBean;
...
public class FlowAdapter extends RecyclerView.Adapter<FlowAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public void addAll(Collection<? extends FlowBean> collection){
        int size = list.size();
        list.addAll(collection);
        notifyItemRangeInserted(size, collection.size());
    }

    public void refresh(Collection<? extends FlowBean> collection){
        list = new ArrayList<>();
        list.addAll(collection);
