...
public class WalletCardAdapter extends RecyclerView.Adapter<WalletCardAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_wallet_card_layout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.cardName.setText(bean.getAffiliatedBank());
        holder.manName.setText(bean.getAccountName());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            manName = (TextView) itemView.findViewById(R.id.man_name);
